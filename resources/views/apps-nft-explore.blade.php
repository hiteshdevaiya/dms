...
<link href="{{ url('public/build/libs/nouislider/nouislider.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{ url('public/build/js/pages/apps-nft-explore.init.js') }}"></script>
