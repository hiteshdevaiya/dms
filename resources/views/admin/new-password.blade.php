                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="p-2">
                                            <form action="{{route('confirm-new-password')}}" id="resetpasswordform" method="POST">
                                                @csrf
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0"><a href="{{route('login')}}" class="fw-semibold text-primary text-decoration-underline"> Login here </a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
