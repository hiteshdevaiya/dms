                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                ...
                                <a href="{{route('users.add')}}" class="btn btn-success add-btn"><i
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        @if (isset($val->cover_image) && !empty($val->cover_image))
                                                            @if (file_exists(public_path('/uploads/user_profile') . '/' . $val->cover_image))
                                                            <img class="avatar-xxs rounded-circle image_src object-cover" src="{{ url('public/uploads/user_profile') . '/' . $val->cover_image }}" alt="user-profile-image">
                                                            @else
                                                    ...
                                                    <div class="flex-grow-1 ms-2 name">{{ucfirst($val->name)}}</div>
                                                </div>
                                            </td>
                                            <td class="phone">{{$val->country_code}}{{$val->mobile_no}}</td>
                                            <td class="tags">{{$val->email}}</td>
                                            <td class="company_name">{{(isset($val->user_rights) && !empty($val->user_rights)) ? $val->user_rights->name : ''}}</td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        data-bs-trigger="hover" data-bs-placement="top"
                                                        title="Edit">
                                                        <a class="edit-item-btn" href="{{route('users.edit',$val->id)}}"><i
