...
@section('css')
    ...
    <link href="{{ url('public/build/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet">
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="px-3">
                                            <img src="{{ url('public/build/images/user-illustarator-2.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                <img src="{{ url('public/build/images/illustrator-1.png') }}" class="img-fluid" alt="">
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                    <div class="mt-3 pt-2">
...
@section('script')
    ...
    <!-- dashboard init -->
    <script src="{{ url('public/build/js/pages/dashboard-analytics.init.js') }}"></script>
