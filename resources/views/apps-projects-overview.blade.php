                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-white rounded-circle">
                                                <img src="{{ url('public/build/images/brands/slack.png') }}" alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ url('public/build/images/users/avatar-10.jpg') }}" alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4">
                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                    <div class="col-4">
                                                        <img src="{{ url('public/build/images/small/img-2.jpg') }}" alt=""
                                                            class="img-fluid rounded" />
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-4">
                                                        <img src="{{ url('public/build/images/small/img-3.jpg') }}" alt=""
                                                            class="img-fluid rounded" />
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-4">
                    ...
                    <div class="mb-4 d-flex align-items-center">
                        ...
                        <div class="avatar-group justify-content-center">
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                ...
                                <div class="avatar-xs">
                                    <img src="{{ url('public/build/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle img-fluid">
                                </div>
                            </a>
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{ url('public/build/js/pages/project-overview.init.js') }}"></script>
