...
@endsection
@section('css')
    <link href="{{ url('public/build/libs/nouislider/nouislider.min.css') }}" rel="stylesheet">
...
@section('script')
    ...
    <script src="{{ url('public/build/js/pages/ecommerce-product-list.init.js') }}"></script>
