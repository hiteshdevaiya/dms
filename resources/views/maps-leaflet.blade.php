...
@section('css')
    <link href="{{ url('public/build/libs/leaflet/leaflet.css') }}" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <script src="{{ url('public/build/libs/leaflet/leaflet.js') }}"></script>
    <script src="{{ url('public/build/js/pages/leaflet-us-states.js') }}"></script>
    <script src="{{ url('public/build/js/pages/leaflet-map.init.js') }}"></script>
