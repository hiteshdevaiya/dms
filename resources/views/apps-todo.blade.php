...
@endsection
@section('css')
<link href="{{ url('public/build/libs/dragula/dragula.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="file-manager-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mt-auto text-center">
                <img src="{{url('public/build/images/task.png')}}" alt="Task" class="img-fluid" />
            </div>
        </div>
    </div>
    <!--end side content-->
                                ...
                                <div data-simplebar style="max-height: 141px">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{url('public/build/images/users/avatar-1.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{url('public/build/images/users/avatar-10.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{url('public/build/images/users/avatar-6.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{url('public/build/images/users/avatar-9.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
...
@endsection
@section('script')
<script src="{{url('public/build/libs/dragula/dragula.min.js')}}"></script>
<script src="{{url('public/build/libs/dom-autoscroller/dom-autoscroller.min.js')}}"></script>

<script src="{{url('public/build/js/pages/todo.init.js')}}"></script>
