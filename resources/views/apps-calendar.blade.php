...
@section('css')
    <link href="{{ url('public/build/libs/fullcalendar/main.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ url('public/build/libs/fullcalendar/main.min.js') }}"></script>
    <script src="{{ url('public/build/js/pages/calendar.init.js') }}"></script>
