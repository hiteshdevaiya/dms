...
@section('css')
    <link href="{{ url('public/build/libs/dragula/dragula.min.css') }}" rel="stylesheet">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-group">
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            ...
                                            <img src="{{ url('public/build/images/users/avatar-9.jpg') }}" alt=""
                                                class="rounded-circle avatar-xxs">
                                        </a>
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover"
...
@section('script')
    ...
    <script src="{{ url('public/build/js/pages/tasks-kanban.init.js') }}"></script>
