...
@section('content')
                            ...
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="index" class="d-inline-block auth-logo">
                                        <img src="{{ url('public/build/images/logo-light.png') }}" alt="" height="20">
                                    </a>
                                </div>
        ...
        @endsection
        @section('script')
            <script src="{{ url('public/build/libs/particles.js/particles.js') }}"></script>
            <script src="{{ url('public/build/js/pages/particles.app.js') }}"></script>
            <script src="{{ url('public/build/js/pages/form-validation.init.js') }}"></script>
            <script src="{{ url('public/build/js/pages/passowrd-create.init.js') }}"></script>
        @endsection
