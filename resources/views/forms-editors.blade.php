...
@section('css')
    <link href="{{ url('public/build/libs/quill/quill.core.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('public/build/libs/quill/quill.bubble.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('public/build/libs/quill/quill.snow.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
@section('script')
    ...
    <script src="{{ url('public/build/libs/quill/quill.min.js') }}"></script>
    <script src="{{ url('public/build/js/pages/form-editor.init.js') }}"></script>
