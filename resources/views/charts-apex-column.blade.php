...
<script src="{{ url('public/https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.11.0/dayjs.min.js') }}"></script>
<script src="{{ url('public/https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.11.0/plugin/quarterOfYear.min.js') }}"></script>

<script src="{{ url('public/build/js/pages/apexcharts-column.init.js') }}"></script>
