                            ...
                            <div>
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                        <img src="{{url('public/build/images/users/user-dummy-img.jpg')}}" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="#" class="form-steps" autocomplete="off">
                    <div class="text-center pt-3 pb-4 mb-1">
                        <img src="{{url('public/build/images/logo-dark.png')}}" alt="" height="17">
                    </div>
...
@endsection
@section('script')
<script src="{{ url('public/build/js/pages/form-wizard.init.js') }}"></script>
