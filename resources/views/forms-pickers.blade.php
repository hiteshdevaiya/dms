...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ url('public/build/libs/@simonwep/pickr/themes/classic.min.css') }}" /> <!-- 'classic' theme -->
    <link rel="stylesheet" href="{{ url('public/build/libs/@simonwep/pickr/themes/monolith.min.css') }}" /> <!-- 'monolith' theme -->
    <link rel="stylesheet" href="{{ url('public/build/libs/@simonwep/pickr/themes/nano.min.css') }}" /> <!-- 'nano' theme -->
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ url('public/build/libs/@simonwep/pickr/pickr.min.js') }}"></script>
    <script src="{{ url('public/build/js/pages/form-pickers.init.js') }}"></script>
