...
@section('css')
<link href="{{ url('public/build/libs/multi.js/multi.min.css') }}" rel="stylesheet">
<link href="{{ url('public/build/libs/@tarekraafat/autocomplete.js/css/autoComplete.css') }}" rel="stylesheet">
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <div class="input-group" data-input-flag>
                                <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{url('public/build/images/flags/us.svg')}}" alt="flag img" height="20" class="country-flagimg rounded"><span class="ms-2 country-codeno">+ 1</span></button>
...
@endsection
@section('script')
<script src="{{ url('public/build/libs/multi.js/multi.min.js') }}"></script>
<script src="{{ url('public/build/libs/@tarekraafat/autocomplete.js/autoComplete.min.js') }}"></script>
<script src="{{ url('public/build/js/pages/form-advanced.init.js') }}"></script>
<script src="{{ url('public/build/js/pages/form-input-spin.init.js') }}"></script>
<!-- input flag init -->
<script src="{{url('public/build/js/pages/flag-input.init.js')}}"></script>
