...
@section('script')
    ...
    <script src="{{ url('public/build/libs/jsvectormap/maps/canada.js') }}"></script>
    <script src="{{ url('public/build/libs/jsvectormap/maps/russia.js') }}"></script>
    <script src="{{ url('public/build/libs/jsvectormap/maps/spain.js') }}"></script>
    <script src="{{ url('public/build/js/pages/vector-maps.init.js') }}"></script>
