        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link menu-link <?php if( $selected ): ?> active <?php endif; ?>" href="<?php echo e(url('admin/categories')); ?>">
...
<?php /**PATH C:\xampp\htdocs\dms\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>