                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                ...
                                <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                    <a href="<?php echo e(route('countries.add')); ?>" class="btn btn-success add-btn"><i
                                        class="ri-add-line align-bottom me-1"></i> Add Country</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody class="list form-check-all">
                                    <?php if(isset($users) && !empty($users)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php endif; ?>
                                            <td  class="company_name">(<?php echo e($val->country_code); ?>) <?php echo e(ucfirst($val->title)); ?> </td>
                                            <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a class="edit-item-btn" href="<?php echo e(route('countries.edit',$val->id)); ?>"><i
                                ...
                                <form accept="" id="delete_form" method="post">
                                    ...
                                    <div class="modal-body p-5 text-center">
                                        ...
                                        <div class="mt-4 text-center">
                                            <h4 class="fs-semibold">You are about to delete a country?</h4>
                                            <p class="text-muted fs-14 mb-4 pt-1">Deleting your country will
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/admin/country/index.blade.php ENDPATH**/ ?>