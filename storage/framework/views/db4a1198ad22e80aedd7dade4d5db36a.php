                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="email" name="email" class="form-control" placeholder="Enter Email Address" value="<?php echo e($data->email ?? ''); ?>" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control onlyNumerics" id="mobile_no_2"
                                                    placeholder="Enter your phone number" name="mobile_no_2" value="<?php echo e($data->mobile_no_2 ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="native_place" name="native_place" class="form-control" placeholder="Enter native place" value="<?php echo e($data->native_place ?? ''); ?>" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input marital_status" type="radio" name="marital_status" value="1" <?php echo e((isset($data) && ($data->marital_status == '1')) ? 'checked' : ''); ?>>
                                                            <label class="form-check-label">
                                                                Single
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input marital_status" type="radio" name="marital_status" value="2" <?php echo e((isset($data) && ($data->marital_status  == '2')) ? 'checked' : ''); ?>>
                                                            <label class="form-check-label">
                                                                Married
                                                            </label>
                                                        </div>
                                        ...
                                        <div class="col-lg-4 marriage_date_div d-none">
                                            <div class="mb-3">
                                               ...
                                               <?php endif; ?>
                                                <input type="text" name="marriage_date" value="<?php echo e($marriage_date ?? ''); ?>" class="form-control flatpickr-input" id="marriage_date" data-provider="flatpickr" data-range="true" placeholder="Select Marriage Date">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input occupatoin_type" type="radio" name="occupatoin_type" value="1" <?php echo e((isset($data->occupation) && ($data->occupation->type == '1')) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label">
                                                        Business
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input occupatoin_type" type="radio" name="occupatoin_type" value="2" <?php echo e((isset($data->occupation) && ($data->occupation->type  == '2')) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label">
                                                        Service
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input occupatoin_type" type="radio" name="occupatoin_type" value="3" <?php echo e((isset($data->occupation) && ($data->occupation->type  == '3')) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label">
                                                        Other
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-lg-4 industry_div">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('industry_id',$industry ?? [],$data->occupation->industry_type ?? '',['class'=>'form-control','id'=>'industry_id','placeholder'=>'Select Industry']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control" placeholder="Enter title" value="<?php echo e($data->occupation->title ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label for="od_country_id" class="form-label">Select Country</label>
                                            <?php echo Form::select('od_country_id',$country ?? '',$data->occupation->country_id ?? '',['class'=>'form-control','id'=>'od_country_id','placeholder'=>'Select Country']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('od_state_id',$state ?? [],$data->occupation->state_id ?? '',['class'=>'form-control','id'=>'od_state_id','placeholder'=>'Select State']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('od_city_id',$city ?? [],$data->occupation->city_id ?? '',['class'=>'form-control','id'=>'od_city_id','placeholder'=>'Select City']); ?>

                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="button" class="btn btn-light changeTab" data-tab="personalDetails">Back</button>
                            ...
                            <div class="tab-pane" id="addressDetails" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="pa_address" name="pa_address" class="form-control" placeholder="Enter Address" value="<?php echo e($data->permanentAddress->address ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="pa_pincode" name="pa_pincode" class="form-control" placeholder="Enter pincode" value="<?php echo e($data->permanentAddress->pincode ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="pa_area" name="pa_area" class="form-control" placeholder="Enter Area/Village" value="<?php echo e($data->permanentAddress->area ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('pa_country_id',$country ?? '',$data->permanentAddress->country_id ?? '',['class'=>'form-control','id'=>'pa_country_id','placeholder'=>'Select Country']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('pa_state_id',$state ?? [],$data->permanentAddress->state_id ?? '',['class'=>'form-control','id'=>'pa_state_id','placeholder'=>'Select State']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('pa_city_id',$city ?? [],$data->permanentAddress->city_id ?? '',['class'=>'form-control','id'=>'pa_city_id','placeholder'=>'Select City']); ?>
                                ...
                                <div class="row">
                                                ...
                                                <div class="col-md-auto ms-auto">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <select class="form-control mb-0 fillAddress" data-field="ca" name="same_as_address" data-choices data-choices-search-false id="choices-single-default">
                                                            ...
                                                            <?php $__currentLoopData = $address_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($key != 2): ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ca_address" name="ca_address" class="form-control" placeholder="Enter Address" value="<?php echo e($data->communicationAddress->address ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ca_pincode" name="ca_pincode" class="form-control" placeholder="Enter pincode" value="<?php echo e($data->communicationAddress->pincode ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ca_area" name="ca_area" class="form-control" placeholder="Enter Area/Village" value="<?php echo e($data->communicationAddress->area ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ca_country_id',$country ?? '',$data->communicationAddress->country_id ?? '',['class'=>'form-control','id'=>'ca_country_id','placeholder'=>'Select Country']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ca_state_id',$state ?? [],$data->communicationAddress->state_id ?? '',['class'=>'form-control','id'=>'ca_state_id','placeholder'=>'Select State']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ca_city_id',$city ?? [],$data->communicationAddress->city_id ?? '',['class'=>'form-control','id'=>'ca_city_id','placeholder'=>'Select City']); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_address" name="ma_address" class="form-control" placeholder="Enter Address" value="<?php echo e($data->magazineAddress->address ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_pincode" name="ma_pincode" class="form-control" placeholder="Enter pincode" value="<?php echo e($data->magazineAddress->pincode ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_area" name="ma_area" class="form-control" placeholder="Enter Area/Village" value="<?php echo e($data->magazineAddress->area ?? ''); ?>" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ma_country_id',$country ?? '',$data->magazineAddress->country_id ?? '',['class'=>'form-control','id'=>'ma_country_id','placeholder'=>'Select Country']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ma_state_id',$state ?? [],$data->magazineAddress->state_id ?? '',['class'=>'form-control','id'=>'ma_state_id','placeholder'=>'Select State']); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <?php echo Form::select('ma_city_id',$city ?? [],$data->magazineAddress->city_id ?? '',['class'=>'form-control','id'=>'ma_city_id','placeholder'=>'Select City']); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="button" class="btn btn-light changeTab" data-tab="occupationDetails">Back</button>
                            ...
                            <div class="tab-pane" id="relationDetails" role="tabpanel">
                                <?php if(isset($data->relationships) && count($data->relationships)): ?>
                                    <?php $__currentLoopData = $data->relationships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationshipone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="row">
                                            <input type="hidden" name="oldRelationIds[]" value="<?php echo e($relationshipone->id); ?>" />
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="rd_first_name" class="form-label">First Name</label>
                                                    <input type="text" id="rd_first_name" name="rd_first_name[]" class="form-control" placeholder="Enter First Name" value="<?php echo e($relationshipone->first_name ?? ''); ?>" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="rd_middle_name" class="form-label">Middle Name</label>
                                                    <input type="text" id="rd_middle_name" name="rd_middle_name[]" class="form-control" placeholder="Enter Middle Name" value="<?php echo e($relationshipone->middle_name ?? ''); ?>" />
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="rd_last_name" name="rd_last_name[]" class="form-control" placeholder="Enter Last Name" value="<?php echo e($relationshipone->last_name ?? ''); ?>" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="rd_mobile" class="form-label">Mobile</label>
                                                    <input type="text" id="rd_mobile" name="rd_mobile[]" class="form-control" placeholder="Enter Mobile" value="<?php echo e($relationshipone->mobile ?? ''); ?>" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="rd_relationshipone_id" class="form-label">Select Relationship</label>
                                                    <?php echo Form::select('rd_relationship_id[]',$relationship ?? [],$relationshipone->relation ?? '',['class'=>'form-control','id'=>'rd_relationship_id','placeholder'=>'Select Relationship']); ?>
                                ...
                                <div class="row rd_end">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="button" class="btn btn-light changeTab" data-tab="addressDetails">Back</button>
                            ...
                            <div class="tab-pane" id="documentDetails" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button class="btn btn-light changeTab" data-tab="relationDetails">Back</button>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="mb-3">
                    ...
                    <?php echo Form::select('rd_relationship_id[]',$relationship ?? [],$data->relationship_id ?? '',['class'=>'form-control','id'=>'rd_relationship_id','placeholder'=>'Select Relationship']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/admin/devotee/create.blade.php ENDPATH**/ ?>