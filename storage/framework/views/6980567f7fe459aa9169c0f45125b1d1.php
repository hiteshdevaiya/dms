                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                           <form action="<?php echo e(route('front.login')); ?>" method="POST" id="frontSignInForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mobile', '')); ?>" id="mobile" name="mobile" placeholder="Enter mobile">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <?php if(old('mobile')): ?>
                                                    <div class="mb-3">
                                                        <div class="float-end">
                                                            <a href="<?php echo e(route('front.getForgotPassword')); ?>" class="text-muted">Forgot
                                                                password?</a>
                                                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/front/login.blade.php ENDPATH**/ ?>