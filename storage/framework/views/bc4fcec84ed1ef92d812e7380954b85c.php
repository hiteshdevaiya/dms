                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                           <form action="<?php echo e(route('login')); ?>" method="POST" id="signInForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="<?php echo e(route('getForgotPassword')); ?>" class="text-muted">Forgot
                                                            password?</a>
                                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/admin/login.blade.php ENDPATH**/ ?>