                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                           <form method="POST" action="<?php echo e(route('forgotpassword')); ?>" id="forgotpasswordFrom">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-4">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/admin/forgotpassword.blade.php ENDPATH**/ ?>