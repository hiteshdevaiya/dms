...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        <?php $id = 0;?>
    <?php endif; ?>
    <form class="tablelist-form container-fluid" method="POST" enctype="multipart/form-data" action="<?php echo e(url($actionURL.'/action',$view).'/'.$id ?? 0); ?>" autocomplete="off" id="devoteeform">
            <?php echo csrf_field(); ?>
        <div class="row">            
            <div class="col-xxl-3">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/front/devotee/create.blade.php ENDPATH**/ ?>