                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                <div class="">
                                    <?php echo Form::select('assign_category_id',$category ?? '','',[ 'class'=>'form-control','id'=>'assign_category_id','placeholder'=>'Please Select','style'=>"display: none;"]); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 name"><?php echo e(ucfirst($val->surname)); ?> <?php echo e(ucfirst($val->first_name)); ?> <?php echo e(ucfirst($val->last_name)); ?>

                                                        <?php if(isset($val->category->name) && $val->category->name != ""): ?>
                                                            <span class="badge bg-success"><?php echo e($val->category->name); ?></span>
                                                        <?php endif; ?>
                                                        </div>
                                                </div>
                                            </td>
                    ...
                    <div class="modal fade zoomIn" id="assignCategoryModal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo e(url($actionURL.'/multiple_assign_category/')); ?>" id="assign_form" method="post">
                                    <?php echo csrf_field(); ?>
                        ...
                        <form action="" class="d-flex flex-column justify-content-end h-100">
                            <div class="offcanvas-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <?php echo Form::select('category[]',$category ?? '',$filter['category'] ?? '',[ 'class'=>'form-control','id'=>'category','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="email"
                                        class="form-label text-muted text-uppercase fw-semibold mb-3">Email</label>
                                    <input type="text" name="email" value="<?php echo e($filter['email'] ?? ''); ?>" class="form-control" id="email" placeholder="Serach By Email">
                                </div>
                                <div class="mb-4">
                                    <label for="mobile_no"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-lg-6">
                                            <div class="form-check">
                                                <input class="form-check-input" name="marital_status" type="checkbox"
                                                    id="inlineRadio1" value="1" <?php if(isset($filter['marital_status']) && $filter['marital_status'] == 'a'): ?> checked <?php endif; ?>>
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-check">
                                                <input class="form-check-input" name="marital_status" type="checkbox"
                                                    id="inlineRadio2" value="2" <?php if(isset($filter['marital_status']) && $filter['marital_status'] == '2'): ?> checked <?php endif; ?>>
                                                <label class="form-check-label"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="marriage_date" value="<?php echo e($filter['marriage_date'] ?? ''); ?>" class="form-control flatpickr-input" id="datepicker-range1"
                                        data-provider="flatpickr" data-range="true"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="native_place" value="<?php echo e($filter['native_place'] ?? ''); ?>" class="form-control" id="native_place" placeholder="Serach By Native Place">
                                </div>
                                <div class="mb-4">
                                    <label for="industry_id" class="form-label text-muted text-uppercase fw-semibold mb-3">Business & Service Industry</label>
                                    <?php echo Form::select('industry_id[]',$industry ?? [],$filter['industry_id'] ?? [],[ 'class'=>'form-control','id'=>'industry_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="pa_country_id" class="form-label text-muted text-uppercase fw-semibold mb-3">Country (Permanent Address)</label>
                                    <?php echo Form::select('pa_country_id[]',$country ?? '',$filter['pa_country_id'] ?? '',[ 'class'=>'form-control','id'=>'pa_country_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="pa_state_id" class="form-label text-muted text-uppercase fw-semibold mb-3">State (Permanent Address)</label>
                                    <?php echo Form::select('pa_state_id[]',$state ?? [],$filter['pa_state_id'] ?? [],[ 'class'=>'form-control','id'=>'pa_state_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="pa_city_id" class="form-label text-muted text-uppercase fw-semibold mb-3">City (Permanent Address)</label>
                                    <?php echo Form::select('pa_city_id[]',$city ?? [],$filter['pa_city_id'] ?? [],[ 'class'=>'form-control','id'=>'pa_city_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>

                                <div class="mb-4">
                                    <label for="ca_country_id" class="form-label text-muted text-uppercase fw-semibold mb-3">Country (Communication Address)</label>
                                    <?php echo Form::select('ca_country_id[]',$country ?? '',$filter['ca_country_id'] ?? '',[ 'class'=>'form-control','id'=>'ca_country_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="ca_state_id" class="form-label text-muted text-uppercase fw-semibold mb-3">State (Communication Address)</label>
                                    <?php echo Form::select('ca_state_id[]',$state ?? [],$filter['ca_state_id'] ?? [],[ 'class'=>'form-control','id'=>'ca_state_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="ca_city_id" class="form-label text-muted text-uppercase fw-semibold mb-3">City (Communication Address)</label>
                                    <?php echo Form::select('ca_city_id[]',$city ?? [],$filter['ca_city_id'] ?? [],[ 'class'=>'form-control','id'=>'ca_city_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>

                                <div class="mb-4">
                                    <label for="ma_country_id" class="form-label text-muted text-uppercase fw-semibold mb-3">Country (Magazine Address)</label>
                                    <?php echo Form::select('ma_country_id[]',$country ?? '',$filter['ma_country_id'] ?? '',[ 'class'=>'form-control','id'=>'ma_country_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="ma_state_id" class="form-label text-muted text-uppercase fw-semibold mb-3">State (Magazine Address)</label>
                                    <?php echo Form::select('ma_state_id[]',$state ?? [],$filter['ma_state_id'] ?? [],[ 'class'=>'form-control','id'=>'ma_state_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>

                                </div>
                                <div class="mb-4">
                                    <label for="ma_city_id" class="form-label text-muted text-uppercase fw-semibold mb-3">City (Magazine Address)</label>
                                    <?php echo Form::select('ma_city_id[]',$city ?? [],$filter['ma_city_id'] ?? [],[ 'class'=>'form-control','id'=>'ma_city_id','data-select2init'=>'true','multiple'=>'true','data-placeholder'=>'Please Select']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/admin/devotee/index.blade.php ENDPATH**/ ?>