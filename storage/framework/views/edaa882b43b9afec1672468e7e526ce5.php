...
#passport_file,#pan_card_file,#aadhar_card_file {
    ...
    <?php else: ?>
        <?php $id = 0;?>
    <?php endif; ?>
    <form class="tablelist-form" method="POST" enctype="multipart/form-data" action="<?php echo e(url($actionURL.'/action',$view).'/'.$id ?? 0); ?>" autocomplete="off" id="frontdevoteeform">
            <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-xxl-3">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/front/devotee/create.blade.php ENDPATH**/ ?>