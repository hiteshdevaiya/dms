                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="p-2">
                                            <form action="<?php echo e(route('front.confirm.password')); ?>" id="newPasswordForm" method="POST">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0"><a href="<?php echo e(route('front.login')); ?>" class="fw-semibold text-primary text-decoration-underline"> Login here </a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/front/new-password.blade.php ENDPATH**/ ?>