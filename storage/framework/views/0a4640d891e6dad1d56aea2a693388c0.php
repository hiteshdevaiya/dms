                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                ...
                                <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                    <a href="<?php echo e(route('categories.add')); ?>" class="btn btn-success add-btn"><i
                                        class="ri-add-line align-bottom me-1"></i> Add Categoty</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody class="list form-check-all">
                                    <?php if(isset($categories) && !empty($categories)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php endif; ?>
                                            <td  class="company_name"><?php echo e(ucfirst($val->name)); ?> </td>
                                            <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a class="edit-item-btn" href="<?php echo e(route('categories.edit',$val->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms\resources\views/admin/category/index.blade.php ENDPATH**/ ?>