                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                ...
                                <a href="<?php echo e(route('users.add')); ?>" class="btn btn-success add-btn"><i
                                        class="ri-add-line align-bottom me-1"></i> Add Users</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table align-middle" id="example">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="tags">Email</th>
                                        <th class="sort" data-sort="company_name">Rights</th>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <?php if(isset($val->cover_image) && !empty($val->cover_image)): ?>
                                                            <?php if(file_exists(public_path('/uploads/user_profile') . '/' . $val->cover_image)): ?>
                                                            <img class="avatar-xxs rounded-circle image_src object-cover" src="<?php echo e(url('public/uploads/user_profile') . '/' . $val->cover_image); ?>" alt="user-profile-image">
                                                            <?php else: ?>
                                                    ...
                                                    <div class="flex-grow-1 ms-2 name"><?php echo e(ucfirst($val->name)); ?></div>
                                                </div>
                                            </td>
                                            <td class="phone"><?php echo e($val->country_code); ?><?php echo e($val->mobile_no); ?></td>
                                            <td class="tags"><?php echo e($val->email); ?></td>
                                            <td class="company_name"><?php echo e((isset($val->user_rights) && !empty($val->user_rights)) ? $val->user_rights->name : ''); ?></td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        data-bs-trigger="hover" data-bs-placement="top"
                                                        title="Edit">
                                                        <a class="edit-item-btn" href="<?php echo e(route('users.edit',$val->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/admin/user/index.blade.php ENDPATH**/ ?>