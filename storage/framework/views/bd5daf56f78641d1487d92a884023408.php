<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.states'); ?>
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                ...
                                <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                    <a href="<?php echo e(route('states.add')); ?>" class="btn btn-success add-btn"><i
                                        class="ri-add-line align-bottom me-1"></i> Add State</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table align-middle" id="example">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="company_name">State</th>
                                        <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                ...
                                <tbody class="list form-check-all">
                                    <?php if(isset($users) && !empty($users)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td  class="company_name"><?php echo e(ucfirst($val->title)); ?> </td>
                                            <?php if(auth()->guard('admin')->user()->rights != 3): ?>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a class="edit-item-btn" href="<?php echo e(route('states.edit',$val->id)); ?>"><i
                                ...
                                <form accept="" id="delete_form" method="post">
                                    ...
                                    <div class="modal-body p-5 text-center">
                                        ...
                                        <div class="mt-4 text-center">
                                            <h4 class="fs-semibold">You are about to delete a state?</h4>
                                            <p class="text-muted fs-14 mb-4 pt-1">Deleting your state will
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digicampus/public_html/dms.digicampus.app/resources/views/admin/state/index.blade.php ENDPATH**/ ?>